<script setup lang="ts">
    ...
    let isRecordingEnabled = ref<boolean>(false)
    ...
    function start(){
        ...
        //if recording is enable, it start when playing
        if(isRecordingEnabled.value === true) {
            startRecording()
        }
    }
    ...
    function stop(){
        ...
        //if recording is enabled and we stop playing, the recording stop<
        if(isRecordingEnabled.value === true){
           stopRecording()
        }
    }
...
<template>
    ...
    <div class="sequencerControlsWrapper">
        <div class="sequencerControls">
            <button v-show="! isRecordingEnabled" @click="(event) => enableRecording()">&#x25EF</button>
            <button v-show="isRecordingEnabled" @click="(event) => disableRecording()">&#x2B24;</button>
